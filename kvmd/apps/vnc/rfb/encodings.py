...
class RfbClientEncodings:  # pylint: disable=too-many-instance-attributes
    ...
    has_resize: bool        = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.RESIZE))
    has_rename: bool        = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.RENAME))
    has_leds_state: bool    = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.LEDS_STATE))
    has_ext_keys: bool      = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.EXT_KEYS))
    has_ext_mouse: bool     = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.EXT_MOUSE))
    has_cont_updates: bool  = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.CONT_UPDATES))

    has_tight: bool         = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.TIGHT))
    tight_jpeg_quality: int = dataclasses.field(default=0,     metadata=_make_meta(frozenset(RfbEncodings.TIGHT_JPEG_QUALITIES)))

    has_h264: bool          = dataclasses.field(default=False, metadata=_make_meta(RfbEncodings.H264))
